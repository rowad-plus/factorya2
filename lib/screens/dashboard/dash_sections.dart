...
class _MyFactorySectionState extends State<MyFactorySection> {
  ...
  Widget build(BuildContext context) {
    ...
    final keep = <String, String>{
      ...
      if (f?['country_id'] != null) 'country_id': '${f!['country_id']}',
      if (f?['city_id'] != null) 'city_id': '${f!['city_id']}',
    };
      ...
      child: f == null
          ...
          : ListView(padding: const EdgeInsets.only(top: 12, bottom: 30), children: [
              tile(Icons.info_outline, td('factories.info'), () => _step(1, td('factories.info'), [
                    ...
                    DField('short_description', td('factories.short_description'), type: FT.multiline, translated: true),
                    ...
                    DField('status', td('factories.status'), type: FT.select, options: [('active', 'factories.active'), ('inactive', 'factories.inactive'), ('draft', 'factories.draft')]),
              ...
              tile(Icons.list_alt, td('factories.factory_activities'), () => _step(3, td('factories.factory_activities'), [DField('activities', '${td('factories.activity')} (${td('factories.activity_placeholder')})', type: FT.lines, required: true, hint: '↵')])),
              ...
              tile(Icons.contact_phone_outlined, td('factories.contact_info'), () => _step(4, td('factories.contact_info'), [
